...
public class LiveScoring_HOCKEY2 extends Application
    ...
    public static void main(String[] args) throws Exception
		...
		if (number_of_teams % 2 == 1)
			{
			log("There are an odd number of teams in the contest");
			System.exit(0);
			}
		
		number_of_games = number_of_teams / 2;
		...
		last_update = registration_deadline;
...
//-----------------------------------------------------------------------------------------------------   
    ...
    static boolean exit_if_games_ended()
      	...
      	if (game_ended_flags.size() != number_of_games) return false;
